        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CarrinhoCompras_Usuarios_UsuarioId1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Pagamentos_CarrinhoCompras_CarrinhoId",
            ...
            migrationBuilder.InsertData(
                table: "Produtos",
                columns: new[] { "ProdutoId", "CarrinhoId", "Descricao", "IdCategoria", "ImageMimeType", "Nome", "PhotoFileName", "Preco", "Stock", "Url" },
                values: new object[,]
                {
                    { 1, 0, "Banana importada da Colombia.", 1, "image/jpeg", "Banana", "banana1.jpg", 0.99f, 10, "https://ac2020storage.blob.core.windows.net/joaomachado/banana1.jpg" },
                    { 2, 0, "Clementina natural de Portugal", 1, "image/jpeg", "Clementina", "clementina.jpg", 0.79f, 100, "https://ac2020storage.blob.core.windows.net/joaomachado/clementina.jpg" },
                    { 3, 0, "Maça fuji, importada", 1, "image/jpeg", "Maça Fuji", "fuji.jpg", 0.59f, 150, "https://ac2020storage.blob.core.windows.net/joaomachado/fuji.jpg" },
                    { 4, 0, "Kiwi, directamente da nossa quinta", 1, "image/jpeg", "Kiwi", "kiwi.jpg", 3.99f, 300, "https://ac2020storage.blob.core.windows.net/joaomachado/kiwi.jpg" },
                    { 5, 0, "O melhor limão de Portugal", 1, "image/jpeg", "Limão", "limao-siciliano.jpg", 0.99f, 150, "https://ac2020storage.blob.core.windows.net/joaomachado/limao-siciliano.jpg" },
                    { 6, 0, "O melhor melão. Importado do Brasil", 1, "image/jpeg", "Melão", "melao.jpg", 1.99f, 200, "https://ac2020storage.blob.core.windows.net/joaomachado/melao.jpg" },
                    { 7, 0, "Pera natural, diretamente da nossa quinta", 1, "image/jpeg", "Peras", "peras.jpg", 0.99f, 200, "https://ac2020storage.blob.core.windows.net/joaomachado/peras.jpg" },
                    { 8, 0, "Uva do Alentejo", 1, "image/jpeg", "Uva", "uvas.jpg", 1.29f, 300, "https://ac2020storage.blob.core.windows.net/joaomachado/uvas.jpg" }
                });
